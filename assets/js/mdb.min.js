  ...
  return (
    (n = [
      ...
      function (t, e, n) {
        ...
        t.exports = function (t) {
          return (
            o(l, t) || (l[t] = a && o(c, t) ? c[t] : u('Symbol.' + t)),
            l[t]
          )
        }
      },
      ...
      function (N, t, e) {
        ...
        function gi(t) {
          return 'html' === C(t)
            ? t
            : t.assignedSlot || t.parentNode || (ri(t) ? t.host : null) || pi(t)
        }
        function mi(t) {
        ...
        class io extends m {
          ...
          _keydown(t) {
            ...
            ;['ArrowLeft', Gr, 'ArrowUp', Zr].includes(t.key) &&
              ...
              (t.focus({ preventScroll: !0 }), io.getOrCreateInstance(t).show())
          }
          _getChildren() {
